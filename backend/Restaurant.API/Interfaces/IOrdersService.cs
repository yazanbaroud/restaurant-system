...
public interface IOrdersService
{
    ...
    Task<PagedResponseDto<OrderResponseDto>> GetPagedAsync(OrderStatus? status, KitchenStatus? kitchenStatus, DateOnly? date, DateOnly? from, DateOnly? to, PaymentStatus? paymentStatus, OrderType? orderType, bool activeOnly, int page, int pageSize, CancellationToken cancellationToken);
    Task<IReadOnlyCollection<OrderResponseDto>> GetSaladsAsync(CancellationToken cancellationToken);
    Task<IReadOnlyCollection<OrderResponseDto>> GetKitchenAsync(CancellationToken cancellationToken);
    ...
    Task<OrderResponseDto> AdvanceSaladStatusAsync(int id, int changedByUserId, CancellationToken cancellationToken);
    ...
    Task<OrderResponseDto> UpdateItemStatusAsync(int id, int itemId, int changedByUserId, UpdateOrderItemStatusDto dto, CancellationToken cancellationToken);
